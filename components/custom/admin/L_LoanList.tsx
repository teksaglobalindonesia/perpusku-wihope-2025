...
import { StatusBukuType } from '@/app/dashboard/loans/page';

export const L_LoanList = ({ statusBukuItems = [], maxData = 5 }: StatusBukuType) => {
                                    ...
                                    <div className="sm:grid flex-col flex gap-8 sm:grid-cols-12 items-center">
                                        ...
                                        <div className="col-span-3 space-y-4">
                                            <div className="bg-black w-full text-white px-6 py-3 text-sm font-bold tracking-wider inline-block text-center">
                                                {/* {getStatusLabel(item.return)}  */}
                                                {item.return === null ? 'SEDANG DIPINJAM' : 'SUDAH DIKEMBALIKAN'}
                                            </div>
