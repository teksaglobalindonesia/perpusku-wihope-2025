        ...
        <>
            <div className="bg-[#edf0f1] mx-[100px] my-[50px] drop-shadow-lg rounded-lg pb-4">
                <div className="flex justify-between items-center px-6 py-6">
                    <h1 className="text-[24px] text-black font-medium">Pengembalian</h1>
                            ...
                            <div className="px-[19px] py-[19px] flex flex-row justify-between">
                                <div className="flex flex-row gap-4">
                                    <div className="flex flex-col fle">
                                        ...
                                        <h1 className="flex flex-row gap-2">Dikembalikan:<span className="text-[#757575]">{item.dikembali}</span></h1>
                                    </div>
                                </div>
                                <div>
                                    {item.status ? (
