        ...
        <>
            ...
            <div className="bg-[#edf0f1] mx-[100px] my-[50px] drop-shadow-lg rounded-lg pb-4">
                <div className="flex justify-between items-center px-6 py-6">
                    <h1 className="text-[24px] text-black font-semibold">Anggota</h1>
                    <div className="flex items-center gap-3">
                        ...
                        <Link href="/tambah_anggota" className="bg-[#5bbd87] hover:bg-[#4a996d] px-4 py-2 rounded-sm transition text-white">
                            Tambah
                        </Link>
                    </div>
                </div>
                        ...
                        <div className="flex justify-between p-6">
                            <div className="flex gap-6">
                                <div className="flex flex-col justify-between py-2">
                                    <div>
                                        <h1 className="text-[24px] font-semibold text-gray-800">{item.nama}</h1>
                                        <p className="text-[14px] text-[#757575]">{item.id}</p>
