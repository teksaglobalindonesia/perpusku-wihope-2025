export const Edit_buku = () => {
    return (
        <div className="max-w-2xl mx-auto bg-white p-10 rounded-2xl shadow-lg">
            <h1 className="text-3xl font-bold text-black mb-8 pb-4">✏️ Edit Data Buku</h1>
            ...
            <form className="space-y-6">
                ...
                <div className="flex gap-4 pt-6">
                    ...
                    <button
                        type="button"
                        className="bg-[#F57373] text-white px-5 py-2 rounded-lg shadow hover:bg-[#c65d5d] transition"
                    >
                        Hapus
                    </button>
                </div>
