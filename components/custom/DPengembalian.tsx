...
export const DPengembalian = () => {
  return (
    <div className="mb-8 mt-20 flex flex-col gap-4 rounded-2xl border border-beige-300 bg-beige-200 px-4 py-4 shadow-lg shadow-beige-400/30">
      {/* Header Section */}
      <div className="flex justify-between gap-2">
        <h3 className="font-vintage text-3xl font-semibold text-vintage-terracotta">
      ...
      <div className="flex justify-center gap-2">
        <button className="rounded-md border border-beige-300 bg-beige-100 px-3 py-1 font-vintage text-beige-700 shadow-inner hover:bg-beige-300">
          Prev
        </button>
