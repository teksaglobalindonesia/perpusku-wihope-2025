export default function Goodbye(){
    return(
        <>
        <div className="w-full h-auto min-h-[200px] md:h-[300px] flex items-center justify-center bg-[#F0F2BD] py-8">
            <div className="text-center w-full px-4 md:w-[887px] flex flex-col items-center gap-4 md:gap-[32px] font-planewalker">
